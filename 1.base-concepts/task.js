...
function calculateTotalMortgage(percent, contribution, amount, date) {
  ...
  // P - *Это проценты за пользование кредитом или нет?* 1/12 процентной ставки (от 0 до 1), процентная ставка должна быть дробным числом, следовательно, входные данные нужно разделить на 100.
  ...
  //*Сначала я подумала, что это формула для тоталЭмоунт, но он же должен выдавать еще и первоначальный взнос. Или тогда формула для тоталЭмоунт должна выглядеть так: let totalAmount = contribution + (S * (P + P / (((1 + P)**n) - 1)))?*
